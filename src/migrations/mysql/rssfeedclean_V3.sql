...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2022 a las 10:24:56
...
ALTER TABLE `noticias`
  ...
  ADD UNIQUE KEY `noticias_unicas_por_enlace` (`id_url`,`noticia_enlace`);
...
ALTER TABLE `urls`
  ...
  ADD UNIQUE KEY `Columnas unicas` (`enlace`,`id_usuario`),
...
--
ALTER TABLE `noticias`
  MODIFY `id_noticia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=271;
